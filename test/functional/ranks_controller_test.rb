...
class RanksControllerTest < ActionController::TestCase
  ...
  test "should create rank" do
    assert_difference('Rank.count') do
      post :create, rank: { color: @rank.color, custom: @rank.custom, image: @rank.image, min_posts: @rank.min_posts, name: @rank.name }
    end
  ...
  test "should update rank" do
    put :update, id: @rank, rank: { color: @rank.color, custom: @rank.custom, image: @rank.image, min_posts: @rank.min_posts, name: @rank.name }
    assert_redirected_to rank_path(assigns(:rank))
  end
